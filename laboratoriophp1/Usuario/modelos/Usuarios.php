...
{
    //obtener el usuario o la consulta a la base de datos
    $statement =$this->db->prepare("SELECT * FROM usuarios WHERE Usuario =? ") ;
    $statement->execute([$Usuario]);
    $user = $statement->fetch(PDO:: FETCH_ASSOC);
    //ejecutar la consulta como si fuera un array.buscar el dato solicitado en los datos que estan la tabla.
