...
public function delete($Id)
{
	...
	if($statement->execute())
	{
		print"<script>alert('El docente se ha eliminado correctamente'); window.location='../pages/index.php';</script>";
	}else
	{
		 print"<script>alert('El docente no se ha podido eliminar'); window.location='../pages/eliminar.php';</script>";
	}
